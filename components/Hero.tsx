...
export default function Hero({ onOpenBookingModal }: HeroProps) {
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-nova-dark pt-8 pb-16">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#b5f63d]/10 rounded-full blur-[140px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#13151b] border border-[#1e222d] shadow-lg">
              ...
              <span className="w-1.5 h-1.5 rounded-full bg-[#b5f63d]"></span>
              <span className="text-xs text-[#b5f63d] font-bold">10,000+ Happy Rides</span>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 pt-2 border-t border-[#1e222d] max-w-xl">
              ...
              <div>
                <span className="block text-2xl font-black text-[#b5f63d]">₹0 Surge</span>
            ...
            <div className="flex flex-wrap items-center gap-4 pt-4">
              ...
              <a
                ...
                className="px-6 py-4 rounded-xl border border-[#1e222d] bg-[#13151b] hover:border-[#b5f63d] text-slate-200 text-xs font-bold uppercase transition-colors flex items-center gap-2"
              >
                <PhoneCall className="w-4 h-4 text-[#b5f63d]" />
          ...
          >
            <div className="bg-[#13151b] border-2 border-[#1e222d] rounded-2xl p-6 sm:p-7 shadow-2xl relative overflow-hidden">
              <div className="flex items-center justify-between mb-6 pb-4 border-b border-[#1e222d]">
                ...
                <div className="w-9 h-9 rounded-xl bg-[#0b0c10] border border-[#1e222d] text-[#b5f63d] flex items-center justify-center">
              ...
              <form onSubmit={handleWidgetSubmit} className="space-y-4">
                <div>
                  <label className="block text-[11px] font-bold text-slate-300 mb-1 uppercase tracking-wider flex items-center gap-1">
                    <MapPin className="w-3.5 h-3.5 text-[#b5f63d]" /> Pickup Address / City
                  </label>
                  <input
                    type="text"
                    required
                    ...
                    className="w-full bg-[#0b0c10] border border-[#1e222d] rounded-xl px-3.5 py-2.5 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-[#b5f63d]"
                  />
                </div>

                <div>
                  <label className="block text-[11px] font-bold text-slate-300 mb-1 uppercase tracking-wider flex items-center gap-1">
                    <MapPin className="w-3.5 h-3.5 text-[#b5f63d]" /> Destination / Drop Location
                  </label>
                  <input
                    type="text"
                    required
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    <label className="block text-[11px] font-bold text-slate-300 mb-1 uppercase tracking-wider flex items-center gap-1">
                      <Clock className="w-3.5 h-3.5 text-[#b5f63d]" /> Pickup Time
                    </label>
                    <input
                      type="time"
                      value={time}
                ...
                <div>
                  <label className="block text-[11px] font-bold text-slate-300 mb-1 uppercase tracking-wider flex items-center gap-1">
                    <Car className="w-3.5 h-3.5 text-[#b5f63d]" /> Preferred Vehicle
                  </label>
                  <select
                    value={vehicle}
                    onChange={(e) => setVehicle(e.target.value)}
                    className="w-full bg-[#0b0c10] border border-[#1e222d] rounded-xl px-3.5 py-2.5 text-xs text-white focus:outline-none focus:border-[#b5f63d]"
                  >
                    ...
                    <option value="Tempo Traveller (12-17 Seats)">Tempo Traveller (12-17 Seats)</option>
                  </select>
                </div>
